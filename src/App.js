...
export default function App() {
  return (
    ...
    <main className="bg-white pt-16 lg:py-24">
      <div className="bg-slate-100 pb-16 lg:relative lg:z-10 lg:pb-0">
        <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-8 lg:px-8">
          ...
          <div className="mt-12 lg:col-span-2 lg:m-0 lg:pl-8">
            <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0 lg:py-20">
              <blockquote>
                <div>
                  <svg className="h-12 w-12 text-indigo-300 opacity-25" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
                ...
                <footer className="mt-6">
                  <p className="text-base font-medium text-indigo-400">Yuliana Hernandez</p>
                  <p className="text-base font-medium text-indigo-400">Owner | Creative @vivawreaths </p>
                </footer>
              </blockquote>
            </div>
          </div>
    ...
    <main class="bg-white">
        {/* <!-- Header --> */}
        <div class="relative bg-indigo-300 pb-32">
            <div class="absolute inset-0">
                <div class="absolute inset-0 bg-slate-50 mix-blend-multiply" aria-hidden="true"></div>
            </div>
            <div class="relative mx-auto max-w-7xl py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 md:text-5xl lg:text-6xl">Let's collaborate and create something together</h1>
                <p class="mt-6 max-w-3xl text-xl text-indigo-600">
                    Contact us
                </p>
            </div>
        </div>
