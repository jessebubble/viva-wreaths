import { ReactComponent as Banner} from '../banner6.svg'
                        ...
                        <div className="flex flex-1 items-center">
                            <div className="flex flex-col w-full items-center justify-between md:w-auto">
                                <a href="/">
                                    ...
                                    <Banner className='w-full h-full md:w-60 lg:w-48'/>
                                </a>
                            ...
                            <div className="hidden md:ml-10 md:block md:space-x-10">
                                <span className="inline-flex">
                                    <a href="/store" className="inline-flex items-center text-base tracking-tight antialiased font-medium text-indigo-600 hover:text-gray-900 hover:border-b-2 hover:border-indigo-400">
                                        Shop Collection
                                    </a>
                                </span>
                                <span className="inline-flex ">
                                    <a href="/contact" className="inline-flex items-center text-base tracking-tight antialiased font-medium text-gray-700 hover:text-gray-900 hover:border-b-2 hover:border-indigo-600">
                                        Contact Us
                                    </a>
                                </span>
                            </div>
