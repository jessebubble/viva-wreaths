export default function MissedEvent() {
    return (
        <main className="relative overflow-hidden bg-slate-900 pb-20 lg:pb-24">
        ...
        >
          <div className="mx-auto max-w-2xl lg:max-w-none">
            ...
            <p className="mx-auto mt-4 max-w-xl text-xl text-gray-400">
              No problem! We can schedule a local delivery or ship our wreaths directly to you.
