  ...
  return (
    ...
    <div class="relative mx-auto grid max-w-7xl grid-cols-1 gap-x-16 lg:grid-cols-2 lg:px-8 lg:pt-16">
        ...
        <div class="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
            ...
            <div role="list" class="divide-y divide-white divide-opacity-10 text-sm font-medium">
            <li class="flex items-start space-x-4 py-6">
                ...
                <h3 class="text-white">Christmas Wreat</h3>
                <p>Holiday Edition</p>
                <p>2022</p>
                </div>
                <p class="flex-none text-base font-medium text-white">$59.99</p>
            </li>
        ...
        <form>
            ...
            <div class="mt-10">
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="city" 
                        name="city" 
                        autocomplete="address-level2" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        />
                    </div>
                </div>
            ...
            <div class="mt-10">
                ...
                <input 
                    ...
                    type="checkbox" 
                    checked class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                    />
                <div class="ml-2">
